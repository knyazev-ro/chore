  ...
  const chores = [
    {
      ...
      description:
        "Запланировать и запустить рекламную кампанию на всех платформах к 'Black Friday Sale'. Включает создание баннеров, настройку таргетинга и бюджетов.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "To do",
      description:
        "Разработать и внедрить новую функцию чата с поддержкой аудиосообщений.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "Done",
      description:
        "Улучшить время загрузки главной страницы сайта до 2 секунд.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "In progress",
      description:
        "Собрать и проанализировать данные о продажах за последний квартал и подготовить презентацию для совещания.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "To do",
      description:
        "Разработать дизайн и верстку лендинга для продвижения нового продукта компании.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "To do",
      description:
        "Провести полное тестирование системы оплаты на предмет багов и уязвимостей. Включает проверку интеграции с платёжными шлюзами.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "In progress",
      description:
        "Создание технической документации для нового API. Описание эндпоинтов, параметров и примеров запросов.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "Done",
      description:
        "Разработка сценария, съёмка и монтаж рекламного видеоролика для продвижения нового продукта.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "In progress",
      description:
        "Внедрение обновлений для системы безопасности, включая исправления уязвимостей и усиление защиты данных.",
      options: {
        tags: [
    ...
    },
    {
      ...
      status_label: "To do",
      description:
        "Проведение вводного обучения для новых сотрудников по внутренним процессам и инструментам компании.",
      options: {
        tags: [
