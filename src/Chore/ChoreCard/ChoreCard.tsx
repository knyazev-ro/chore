...
export default function ChoreCard({ chore }: { chore: any }) {
  ...
  return (
    ...
    <div className="relative flex flex-col z-10">
      <div className="px-1 py-1 flex w-72 h-48 bg-sky-100 border-2 border-slate-900 border-b-rose-50 rounded-b-2xl">
        <div className="flex flex-col w-full h-full">
          <ChoreHead chore={chore}/>
          <ChoreBody chore={chore}/>
        </div>
      </div>
      <div className="-z-10 absolute px-1 py-1 flex h-48 bg-rose-500 rounded-b-2xl translate-y-0.5 transition-all duration-300"
