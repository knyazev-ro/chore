      ...
      />
        ...
        <div className="p-1 justify-start flex flex-col w-1/12 h-full">
            ...
            <div className='w-full h-full absolute flex justify-between items-center p-0.5'>
                ...
                <SendIcon className='group-active:translate-y-2 transition-all duration-300 ease-in-out active:translate-y-2 group-active:bg-stone-50 rotate-270 bg-stone-100 p-0.5 border-3' sx={{ fontSize: 36, color:"#0C0A09" }} />
                </div>
            </div>
