  ...
  const optionFile = () => {
    switch (type) {
      case 1:
        return (
          <>
            <img className="w-18 h-18 bg-stone-900" src={cover} />
          </>
        );
      ...
      case 3:
        return (
          <>
            <div className="w-18 h-18 flex flex-col items-center justify-center bg-stone-100 gap-1">
              <div>
      ...
      case 6:
        return (
          <>
            <div className="w-18 h-18 bg-stone-100 flex items-center justify-center">
